...
class Matlab(object):
    ...
    def initialize(self):
        ...
        if _global_matlab_ref is None: 
            ...
            _global_matlab_ref = _MatlabInstance(self.interface)
        else:
            self.interface = _global_matlab_ref.instance
    ...
    def checkPath(self, mlPath):
        ...
        obj = osObj(self.get_runtime_version())
